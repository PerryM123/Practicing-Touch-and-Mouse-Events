...
function imageDraggingPractice() {
	...
	let prevX = 0;
	let carousel_width = -($('.image-container').width());
	...
	console.log("carousel_width + windowWidth: " + (carousel_width + windowWidth));
	...
	$mouseUPDOWNLEFTRIGHT.on('mousedown', function(e) {
		...
		if (prevDifference <= (carousel_width + container_width)) {
			$image_container.css('transform', 'translate3d(' + (carousel_width + container_width) + 'px, 0, 0)');
				prevDifference = carousel_width + container_width;
				console.log('whoa2');
		}
...
function MOBILEimageDraggingPractice() {
	...
	console.log("MOBILE: carousel_width: " + carousel_width);
	console.log("MOBILE: windowWidth: " + windowWidth);
	console.log("MOBILE: carousel_width + windowWidth: " + (carousel_width + windowWidth));
